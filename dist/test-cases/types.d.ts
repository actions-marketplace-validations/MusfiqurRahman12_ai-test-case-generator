...
export type ProjectLanguage = 'typescript' | 'javascript' | 'python' | 'java' | 'csharp' | 'go' | 'ruby' | 'php' | 'rust' | 'swift' | 'kotlin' | 'other';
export type ProjectFramework = 'react' | 'nextjs' | 'vue' | 'angular' | 'express' | 'nestjs' | 'fastapi' | 'django' | 'flask' | 'spring' | 'rails' | 'laravel' | 'dotnet' | 'gin' | 'actix' | 'vapor' | 'ktor' | 'unknown';
